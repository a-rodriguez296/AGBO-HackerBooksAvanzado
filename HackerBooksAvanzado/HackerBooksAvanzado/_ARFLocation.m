...
// Make changes to ARFLocation.m instead.

#import "_ARFLocation.h"

const struct ARFLocationAttributes ARFLocationAttributes = {
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct ARFLocationRelationships ARFLocationRelationships = {
	.annotations = @"annotations",
};

@implementation ARFLocationID
@end

@implementation _ARFLocation
...
- (ARFLocationID*)objectID {
	return (ARFLocationID*)[super objectID];
}
