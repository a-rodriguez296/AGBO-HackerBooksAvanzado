...
// Make changes to ARFAuthor.m instead.

#import "_ARFAuthor.h"

const struct ARFAuthorAttributes ARFAuthorAttributes = {
	.name = @"name",
};

const struct ARFAuthorRelationships ARFAuthorRelationships = {
	.books = @"books",
};

@implementation ARFAuthorID
@end

@implementation _ARFAuthor
...
- (ARFAuthorID*)objectID {
	return (ARFAuthorID*)[super objectID];
}
